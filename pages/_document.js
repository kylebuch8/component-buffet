...
class MyDocument extends Document {
  ...
  render() {
    return (
      <Html lang="en">
        <Head>
          <link href="https://static.redhat.com/libs/redhat/redhat-theme/6/advanced-theme.css" rel="stylesheet" />
        ...
        <body unresolved="true">
          ...
          <script type="module" src="https://unpkg.com/@patternfly/pfe-accordion@1.9.3/dist/pfe-accordion.min.js"></script>
